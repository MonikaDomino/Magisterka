...
from collection_classifier import Voting_Classifier, Stacking_Classifier
...
print("")
print("Voting Classier: ", AUC_intervals(Y_test, votC))
print("Stacking Classifier: ", AUC_intervals(Y_test, sC))
